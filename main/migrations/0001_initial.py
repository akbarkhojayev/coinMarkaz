# Generated by Django 5.2.1 on 2025-05-08 07:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('TEACHER', 'Mentor'), ('STUDENT', 'Student')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentors', models.ManyToManyField(to='main.mentor')),
            ],
            options={
                'verbose_name': 'Group',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('point_history', models.JSONField(blank=True, default=list)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('point_type', models.CharField(choices=[('mentor', 'From Mentor'), ('test', 'From Test')], default='mentor', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_correct', models.BooleanField(default=False)),
                ('answer_option', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.answeroption')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.question')),
                ('result', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='main.studenttestresult')),
            ],
        ),
        migrations.CreateModel(
            name='Test',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.mentor')),
